...
public class PrepStatementsMain {
	...
	/**
	 * Main method that manages the sequence of events. Determines way of
	 * receiving connection data, establishes the connection and calls launch
	 * method
	 * 
	 * @param args
	 *            cli arguments
		...
		try {
			...
			if (props.hasValidFile()) { // if a file was found
				...
				if (conn.refused() == false) { // if connection is not refused -> launch
					...
					System.out.println("Data from file incorrect - use CLI arguments");
